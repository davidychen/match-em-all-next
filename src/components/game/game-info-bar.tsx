...
export function GameInfoBar() {
  ...
  return (
    <div className="flex items-center gap-6 rounded-xl bg-purple-50 border border-purple-200 px-4 py-2.5">
      <div className="flex items-center gap-2">
        <span className="text-sm font-medium text-purple-700">
          Your matches:
        </span>
        <span className="inline-flex items-center justify-center min-w-[1.75rem] h-7 rounded-full bg-purple-600 text-white text-sm font-bold px-2">
          {matchData?.count ?? 0}
        </span>
      </div>
